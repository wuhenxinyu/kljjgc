...
(function () {
	...
	$(function () {
		 ...
		 * @param {object} swiper - swiper instance
		 */
		function showPreview(swiper){
			var swiperCustomIndex = swiper.el.querySelectorAll('.swiper-pagination__fraction-index')[0];
			...
			slidesCount = swiper.el.querySelectorAll(".swiper-slide:not(.swiper-slide-duplicate)").length;
			...
			if( swiper.slides[activeSlideIndex - 1].getAttribute("data-slide-title") ){
				swiper.el.querySelectorAll('.swiper-button-next .title')[0].innerHTML = swiper.slides[activeSlideIndex +
				1].getAttribute("data-slide-title");
				swiper.el.querySelectorAll('.swiper-button-prev .title')[0].innerHTML = swiper.slides[activeSlideIndex -
				1].getAttribute("data-slide-title");
			}

			if( swiper.slides[activeSlideIndex - 1].getAttribute("data-slide-subtitle") ) {
				swiper.el.querySelectorAll('.swiper-button-prev .subtitle')[0].innerHTML = swiper.slides[activeSlideIndex -
				1].getAttribute("data-slide-subtitle");
				swiper.el.querySelectorAll('.swiper-button-next .subtitle')[0].innerHTML = swiper.slides[activeSlideIndex +
				1].getAttribute("data-slide-subtitle");
			}

			if( swiper.el.querySelector('.preview__img') !== undefined ){
				swiper.el.querySelector('.swiper-button-prev .preview__img').style.backgroundImage = 'url(' +
					swiper.slides[activeSlideIndex - 1].getAttribute("data-slide-bg") + ")";
				swiper.el.querySelector('.swiper-button-next .preview__img').style.backgroundImage  = "url(" +
					swiper.slides[activeSlideIndex + 1].getAttribute("data-slide-bg") + ")";
			}
		}
		...
		if (plugins.swiper.length) {
			...
			for (let i = 0; i < plugins.swiper.length; i++) {
				...
				let
					...
					pag = $(node).parent().hasClass('swiper-custom-container') ? $(node).parent().find(".swiper-pagination") : $(node).find(".swiper-pagination"),
				...
				params.pagination.renderBullet = (function(pag) {
